...
<div class="p-2 w-64">
	...
	<button on:click={handleLogin} class="bg-blue-500 text-white px-3 py-1 rounded w-full mb-2">
		Log In
	</button>

	<button on:click={goToRegister} class="text-sm text-blue-600 hover:underline w-full">
		Create an account
	</button>
